...
Prox_model.load_state_dict(torch.load('basic_lstm_model'), strict=False)


print(''' Training Prox_model (epsilon=5) with batchnorm after conv layer which gives the best accuracy ''')
best_prox = None
